...
This library provides a thread-safe, asynchronous TCP client implementation for embedded systems using Raspberry Pi Pico's dual-core architecture. It enables safe execution of non-thread-safe operations with proper core affinity guarantees.
