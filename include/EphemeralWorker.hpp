...
namespace AsyncTcp {
     ...
     *
     * The `EphemeralWorker` class is responsible for storing and executing a custom work function
    ...
    public:
         ...
         *
         * @param handler_function Pointer to the function that defines the work logic for this worker.
         *
         ...
         * and an `async_work_on_timeout` as parameters.
         */
        void setHandler(void (*handler_function)(async_context_t *, async_work_on_timeout *));
