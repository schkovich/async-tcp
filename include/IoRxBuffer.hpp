...
namespace async_tcp {
    ...
    using receive_cb = tcp_recv_fn;
        using closed_callback_t = std::function<void()>;
        ...
        class IoRxBuffer {
                ...
                closed_callback_t _closedCb = nullptr;

                void _onReceivedCallback() const;
                void _onClosedCallback() const;
            ...
            public:
                ...
                void setOnClosedCallback(const closed_callback_t &cb);
